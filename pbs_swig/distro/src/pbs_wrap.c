...
static PyObject *_wrap_openrm(PyObject *self, PyObject *args) {
    ...
    if(!PyArg_ParseTuple(args,(char *)"sO:openrm",&arg1,&obj1)) return NULL;
...
static PyObject *_wrap_closerm(PyObject *self, PyObject *args) {
    ...
    if(!PyArg_ParseTuple(args,(char *)"i:closerm",&arg1)) return NULL;
...
static PyObject *_wrap_downrm(PyObject *self, PyObject *args) {
    ...
    if(!PyArg_ParseTuple(args,(char *)"i:downrm",&arg1)) return NULL;
...
static PyObject *_wrap_configrm(PyObject *self, PyObject *args) {
    ...
    if(!PyArg_ParseTuple(args,(char *)"is:configrm",&arg1,&arg2)) return NULL;
...
static PyObject *_wrap_addreq(PyObject *self, PyObject *args) {
    ...
    if(!PyArg_ParseTuple(args,(char *)"is:addreq",&arg1,&arg2)) return NULL;
...
static PyObject *_wrap_allreq(PyObject *self, PyObject *args) {
    ...
    if(!PyArg_ParseTuple(args,(char *)"s:allreq",&arg1)) return NULL;
...
static PyObject *_wrap_flushreq(PyObject *self, PyObject *args) {
    ...
    if(!PyArg_ParseTuple(args,(char *)":flushreq")) return NULL;
    result = (int )flushreq();
...
static PyObject *_wrap_activereq(PyObject *self, PyObject *args) {
    ...
    if(!PyArg_ParseTuple(args,(char *)":activereq")) return NULL;
...
static PyObject *_wrap_fullresp(PyObject *self, PyObject *args) {
    ...
    if(!PyArg_ParseTuple(args,(char *)"i:fullresp",&arg1)) return NULL;
    fullresp(arg1);
...
static PyObject *_wrap_getreq(PyObject *self, PyObject *args) {
    ...
    if(!PyArg_ParseTuple(args,(char *)"i:getreq",&arg1)) return NULL;
